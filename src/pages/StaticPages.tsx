  ...
  <div className="max-w-4xl mx-auto space-y-12 py-12 animate-[fadeIn_0.3s]">
    <div className="text-center">
      ...
      <p className="text-xl text-gray-500 max-w-2xl mx-auto">
        O SouNativo nasceu para eliminar barreiras entre quem sonha em viajar e quem realiza sonhos.
      </p>
    </div>
      ...
      <div className="grid md:grid-cols-3 gap-8 text-center">
        <div>
          ...
          <p className="text-gray-600 text-sm">
            Presente em todos os estados do Brasil, conectando o turismo local.
          </p>
        </div>
        <div>
          <div className="w-16 h-16 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-4 text-primary-600">
          ...
          <p className="text-gray-600 text-sm">
            Processos rigorosos de verificação para garantir sua segurança.
          </p>
        </div>
        <div>
          <div className="w-16 h-16 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-4 text-primary-600">
          ...
          <p className="text-gray-600 text-sm">
            Mais de 50.000 viajantes satisfeitos compartilhando experiências.
          </p>
        </div>
      </div>
    </div>
  ...
  <div className="max-w-3xl mx-auto py-12">
    ...
    <div className="grid md:grid-cols-2 gap-8">
      <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 h-full">
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-4">
            <div className="bg-blue-50 p-3 rounded-full text-primary-600">
              <Mail size={20} />
            </div>
            <div>
              <p className="text-xs font-bold text-gray-400 uppercase">Email</p>
              <p className="font-medium">suporte@sounativo.com</p>
            </div>
          </div>
          <div className="flex items-center gap-4">
      ...
      <form className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 space-y-4">
        ...
        <input
          className="w-full border border-gray-200 p-3 rounded-lg bg-gray-50 focus:bg-white transition-colors outline-none focus:ring-2 focus:ring-primary-200"
  ...
  <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div className="prose prose-blue max-w-none text-gray-700">
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        Ao acessar e usar a plataforma SouNativo, você aceita e concorda em estar vinculado aos
        termos e disposições deste acordo. Se você não concorda com algum dos termos aqui
        estabelecidos, não deve utilizar nossos serviços.
      </p>

      <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">2. Descrição do Serviço</h3>
      <p className="text-gray-700 leading-relaxed mb-4">
        O SouNativo é uma plataforma intermediária que conecta agências de viagens, guias turísticos
        e prestadores de serviços turísticos a consumidores finais. Não somos responsáveis pela
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        ...
        e atualizadas. Você é responsável por manter a confidencialidade de suas credenciais e por
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        ...
        Os pagamentos são processados de forma segura através de gateways certificados. A
        confirmação da reserva está sujeita à disponibilidade e aprovação do prestador.
      </p>

      <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">5. Cancelamentos e Reembolsos</h3>
      <p className="text-gray-700 leading-relaxed mb-4">
        As políticas de cancelamento e reembolso variam conforme a agência e o pacote contratado.
        Leia atentamente as condições específicas na página de cada viagem antes de confirmar sua
        reserva. O SouNativo atua como intermediária e não se responsabiliza por políticas de
        cancelamento definidas pelos prestadores.
      </p>
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        Todo o conteúdo da plataforma, incluindo textos, imagens, logotipos e design, é propriedade
        do SouNativo ou de seus licenciadores e está protegido por leis de propriedade intelectual.
      </p>
  ...
  <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div className="prose prose-blue max-w-none text-gray-700">
      ...
      <p className="text-gray-700 leading-relaxed mb-6">
        No SouNativo, levamos sua privacidade a sério. Esta política descreve como coletamos,
      ...
      {[
        {
          ...
          a: 'Imediatamente após a confirmação do pagamento, disponível no seu Painel.',
        },
        {
        ...
        { q: 'Posso parcelar?', a: 'Sim, a maioria das agências oferece parcelamento em até 12x.' },
        {
          ...
          a: 'Sim, utilizamos criptografia SSL e gateways de pagamento certificados.',
        },
      ].map((faq, i) => (
      ...
      {[1, 2, 3].map((i) => (
        ...
        >
          <div className="h-48 bg-gray-200 group-hover:opacity-90 transition-opacity">
            <img
              src={`https://source.unsplash.com/random/400x300/?travel&sig=${i}`}
          ...
          <div className="p-6">
            ...
            <h3 className="font-bold text-xl mt-2 mb-3 group-hover:text-primary-600 transition-colors">
              10 Destinos imperdíveis para 2024
            </h3>
            <p className="text-gray-500 text-sm line-clamp-3">
              Descubra os lugares que estão em alta e planeje suas férias com antecedência para
...
export const Careers: React.FC = () => (
  <div className="max-w-3xl mx-auto py-12 text-center">
    ...
    <p className="text-xl text-gray-600 mb-10">
      Estamos construindo o futuro do turismo no Brasil.
    </p>
    <div className="bg-blue-50 p-8 rounded-2xl border border-blue-100">
      ...
      <p className="text-gray-600">
        Mas estamos sempre de olho em talentos! Envie seu currículo para{' '}
        <strong>talentos@sounativo.com</strong>
      </p>
    </div>
  </div>
);
    ...
    <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm flex flex-col md:flex-row items-center gap-8">
      <div className="flex-1">
        ...
        <p className="text-gray-600 mb-6">
          Jornalistas e criadores de conteúdo podem entrar em contato direto com nossa equipe de
          comunicação.
        </p>
        <button className="bg-gray-900 text-white px-6 py-3 rounded-lg font-bold hover:bg-gray-800">
          Baixar Press Kit
        </button>
      </div>
