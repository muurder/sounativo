            ...
            <div className="text-center md:text-left flex-1">
              ...
              {avgRating > 0 && (
                <div className="flex items-center justify-center md:justify-start gap-1 text-amber-500 font-bold text-sm">
                  <Star size={16} className="fill-current" /> {avgRating.toFixed(1)}{' '}
                  <span className="text-gray-400 font-normal">({reviews.length} avaliações)</span>
                </div>
              )}
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-2">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            Viagens Disponíveis ({trips.length})
          </h2>
          {trips.length > 0 ? (
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-24">
            <h3 className="text-lg font-bold text-gray-900 mb-4 flex items-center">
              <MessageCircle className="mr-2 text-primary-500" /> Avaliações
            </h3>
            {reviews.length > 0 ? (
