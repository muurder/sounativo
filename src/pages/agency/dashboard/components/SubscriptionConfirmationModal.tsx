      ...
      >
        ...
        <div className="bg-gradient-to-r from-primary-600 to-primary-700 p-6 text-white">
          ...
          <p className="text-primary-50 text-sm">
            Siga os passos abaixo para finalizar sua assinatura
          </p>
        </div>
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 rounded-xl p-5 space-y-4">
              ...
              {hasNubankLink && (
                <div className="bg-white rounded-lg p-4 border border-green-200 flex flex-col items-center gap-3">
                  <img src={qrCodeUrl} alt="QR Code PIX Nubank" className="w-40 h-40 rounded-lg" />
                  <button
          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
              <p className="text-sm text-gray-700 leading-relaxed">
                Após realizar a transferência, envie o comprovante no nosso WhatsApp para ativarmos
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 flex items-start gap-2">
            ...
            <p className="text-xs text-amber-800 leading-relaxed">
              <strong>Atenção:</strong> A liberação do plano ocorre em instantes após a conferência
              do pagamento.
            </p>
          </div>
