        ...
        <div className="space-y-4">
          {topTrips.map((trip, idx) => (
            <div
              ...
              onClick={() => window.open(`/#/${trip.slug}`, '_blank')}
            >
              <span
                className={`font-bold text-lg w-6 text-center ${idx < 3 ? 'text-amber-500' : 'text-gray-300'}`}
              >
                {idx + 1}
              </span>
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 text-xs text-gray-500">
                  <span className="flex items-center">
                    <ShoppingBag size={10} className="mr-1" /> {trip.sales || 0} vendas
                  </span>
                  <span className="flex items-center">
                    <Eye size={10} className="mr-1" /> {trip.views || 0} views
                  </span>
                </div>
              </div>
