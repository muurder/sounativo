                  ...
                  return (
                    <tr key={booking.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex flex-col">
                          <span className="text-sm font-bold text-gray-900">
                            {booking._trip?.title || 'N/A'}
                          </span>
                          <span className="text-xs text-gray-500">
                            {booking._trip?.destination || ''}
                          </span>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4 text-right font-bold text-gray-900">
                        R${' '}
                        {booking.totalPrice.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
                      </td>
                      <td className="px-6 py-4">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 pt-2 border-t border-gray-200/50">
                      ...
                      <div className="text-right">
                        ...
                        {isNew && (
                          <span className="text-[10px] text-green-600 font-bold block">NOVO</span>
                        )}
                      </div>
                    </div>
        ...
        (() => {
          ...
          const generatePDF = async () => {
            ...
            try {
              ...
              if (bookingPassengers.length > 0) {
                bookingPassengers.forEach((passenger, index) => {
                  ...
                  if (passenger.birth_date) {
                    doc.text(
                      `Data de Nascimento: ${new Date(passenger.birth_date).toLocaleDateString('pt-BR')}`,
                      25,
                      y
                    );
                    y += 6;
              ...
              doc.setFont('helvetica', 'normal');
              doc.text(
                '1. Apresente este voucher (digital ou impresso) no momento do check-in.',
                20,
                y
              );
              y += 6;
              ...
              y += 6;
              doc.text(
                '3. Chegue com pelo menos 30 minutos de antecedência ao ponto de encontro.',
                20,
                y
              );
              y = 280;
              ...
              doc.text(
                'Emitido por SouNativo - O maior marketplace de viagens do Brasil.',
                105,
                y,
                { align: 'center' }
              );
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4 flex-wrap">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-primary-100 text-sm font-mono">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-white text-base font-mono font-bold bg-white/20 px-2 py-1 rounded">
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-5 border border-blue-100">
                      ...
                      <p className="text-lg font-bold text-gray-900 mb-1">
                        {selectedBooking._trip?.title || 'N/A'}
                      </p>
                    ...
                    <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-5 border border-green-100">
                      ...
                      <p className="text-2xl font-bold text-green-600">
                        R${' '}
                        {selectedBooking.totalPrice.toLocaleString('pt-BR', {
                          minimumFractionDigits: 2,
                        })}
                      </p>
                      <p className="text-xs text-gray-500 mt-1">
                        R${' '}
                        {(selectedBooking.totalPrice / selectedBooking.passengers).toLocaleString(
                          'pt-BR',
                          { minimumFractionDigits: 2 }
                        )}{' '}
                        por passageiro
                    ...
                    <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-5 border border-purple-100">
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        {selectedBooking.passengers === 1 ? 'passageiro' : 'passageiros'}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-6 border border-amber-100">
                    <h3 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
                      <CreditCardIcon size={20} className="text-amber-600" /> Informações
                      Financeiras
                    </h3>
                  ...
                  {bookingPassengers.length > 0 ? (
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                      <h3 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
                        <Users size={20} className="text-primary-600" /> Passageiros (
                              ...
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  <p className="font-bold text-gray-900">
                                    {passenger.full_name || `Passageiro ${index + 1}`}
                                  </p>
                                  <p className="text-xs text-gray-500">
                                    {index === 0
                                      ? 'Passageiro Principal (Titular)'
                                      : `Acompanhante ${index}`}
                                  </p>
                                </div>
                              </div>
                              ...
                              {passenger.birth_date && (
                                <div>
                                  ...
                                  <p className="font-medium text-gray-900">
                                    {new Date(passenger.birth_date).toLocaleDateString('pt-BR')}
                                  </p>
                                </div>
                              )}
                              {passenger.whatsapp && (
    ...
    <>
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <h3 className="text-lg font-bold text-gray-900 mb-4 flex items-center">
          <ShoppingBag size={20} className="mr-2 text-primary-600" /> Últimas Vendas
        </h3>
