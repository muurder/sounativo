...
const InboxFeedCard: React.FC<InboxFeedCardProps> = ({
  ...
  return (
    <div
      className={`relative bg-white rounded-xl border border-stone-200 shadow-sm overflow-hidden transition-all hover:shadow-md ${markedAsRead ? 'opacity-70' : ''} ${className}`}
    >
      {/* Left accent border */}
