    ...
    >
      ...
      >
        ...
        <div className={`${config.bg} ${config.border} border-b p-6 relative overflow-hidden`}>
          ...
          {/* Icon */}
          <div
            className={`relative w-16 h-16 ${config.iconBg} rounded-full flex items-center justify-center mx-auto border-2 ${config.border} shadow-lg`}
          >
        ...
        <div className="p-6">
          <div className="text-center mb-6">
            <h3 id="dialog-title" className="text-xl font-bold text-gray-900 mb-3">
              {title}
            </h3>
