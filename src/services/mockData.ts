...
export const PLANS: Plan[] = [
  {
    ...
    name: 'Starter',
    price: 0,
    features: ['2 Viagens Ativas', 'Página Dedicada'],
  },
  {
    id: 'BASIC',
    name: 'Básico',
    price: 59.9,
    features: ['5 Viagens Ativas', 'Página Dedicada', 'Suporte por WhatsApp', 'Suporte por Email'],
  },
  {
    id: 'PREMIUM',
    name: 'Premium',
...
const getImg = (key: string) => {
  const db: Record<string, string> = {
    // Classics
    iguacu:
      'https://images.unsplash.com/photo-1583589483229-3616196d1199?auto=format&fit=crop&w=1000&q=80',
    rio: 'https://images.unsplash.com/photo-1483729558449-99ef09a8c325?auto=format&fit=crop&w=1000&q=80',
    amazon:
      'https://images.unsplash.com/photo-1558980664-23c97b2a3e52?auto=format&fit=crop&w=1000&q=80',
    noronha:
      'https://images.unsplash.com/photo-1519046904884-53103b34b206?auto=format&fit=crop&w=1000&q=80',
    pantanal:
      'https://images.unsplash.com/photo-1581260502159-c9204828d5f6?auto=format&fit=crop&w=1000&q=80',
    bonito:
      'https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?auto=format&fit=crop&w=1000&q=80',
    lencois:
      'https://images.unsplash.com/photo-1564053489984-317bbd824340?auto=format&fit=crop&w=1000&q=80',
    paraty:
      'https://images.unsplash.com/photo-1565883252377-5b56439809d1?auto=format&fit=crop&w=1000&q=80',
    chapada:
      'https://images.unsplash.com/photo-1504217051514-96afa06398be?auto=format&fit=crop&w=1000&q=80',
    salvador:
      'https://images.unsplash.com/photo-1574008526236-4e7807e16305?auto=format&fit=crop&w=1000&q=80',
    sp: 'https://images.unsplash.com/photo-1578305762432-0151b480575e?auto=format&fit=crop&w=1000&q=80',
    ouropreto:
      'https://images.unsplash.com/photo-1565036566849-d94124397d47?auto=format&fit=crop&w=1000&q=80',
    jalapao:
      'https://images.unsplash.com/photo-1545663079-82ce546e526f?auto=format&fit=crop&w=1000&q=80',
    roraima:
      'https://images.unsplash.com/photo-1518182177546-076727620017?auto=format&fit=crop&w=1000&q=80',
    ilhabela:
      'https://images.unsplash.com/photo-1563476560-5bf90902c6c2?auto=format&fit=crop&w=1000&q=80',
    gramado:
      'https://images.unsplash.com/photo-1613323593608-abc90fec84ff?auto=format&fit=crop&w=1000&q=80',
    floripa:
      'https://images.unsplash.com/photo-1590625583337-4b12232213c5?auto=format&fit=crop&w=1000&q=80',

    // New Destinations (Cheap / Near SP)
    saothome:
      'https://images.unsplash.com/photo-1569435222406-277565b3d671?auto=format&fit=crop&w=1000&q=80',
    trindade:
      'https://images.unsplash.com/photo-1564606638689-6761b91b7143?auto=format&fit=crop&w=1000&q=80',
    sana: 'https://images.unsplash.com/photo-1446488614252-0675d316c645?auto=format&fit=crop&w=1000&q=80', // Nature fallback
    maromba:
      'https://images.unsplash.com/photo-1432405972618-c60b0225b8f9?auto=format&fit=crop&w=1000&q=80', // Waterfall fallback
    wine: 'https://images.unsplash.com/photo-1506377247377-2a5b3b417ebb?auto=format&fit=crop&w=1000&q=80',
    aparecida:
      'https://images.unsplash.com/photo-1601662233367-c80675172d44?auto=format&fit=crop&w=1000&q=80',
    macela:
      'https://images.unsplash.com/photo-1533241242200-325c572668b9?auto=format&fit=crop&w=1000&q=80',
    arraial:
      'https://images.unsplash.com/photo-1589824462580-75c1b79218b7?auto=format&fit=crop&w=1000&q=80',
    ilhamel:
      'https://images.unsplash.com/photo-1621269656186-670a8d00556e?auto=format&fit=crop&w=1000&q=80',
    ubatuba:
      'https://images.unsplash.com/photo-1579547945413-497e1b99dac0?auto=format&fit=crop&w=1000&q=80',
    campos:
      'https://images.unsplash.com/photo-1596739203417-c768269c4231?auto=format&fit=crop&w=1000&q=80',
    ilhagrande:
    ...
    urbano:
      'https://images.unsplash.com/photo-1449824913929-6513b64e301f?auto=format&fit=crop&w=1000&q=80',
    aventura:
...
const reportAgenciesData = [
  {
    name: 'Paraíso das Cataratas',
    desc: 'Especialistas em Foz do Iguaçu e região.',
    logoKey: 'iguacu',
  },
  {
    name: 'Carioca Urbano Tours',
    desc: 'A alma do Rio de Janeiro em passeios culturais.',
    logoKey: 'rio',
  },
  { name: 'Amazônia Selvagem', desc: 'Expedições autênticas na floresta.', logoKey: 'amazon' },
  {
    name: 'Ilhas Românticas',
    desc: 'Lua de mel e viagens de casal exclusivas.',
    logoKey: 'noronha',
  },
  {
    name: 'Pantanal Safaris',
    desc: 'Ecoturismo e fotografia de vida selvagem.',
    logoKey: 'pantanal',
  },
  {
    name: 'Lendas do Nordeste',
    desc: 'Cultura, história e praias do Nordeste.',
    logoKey: 'salvador',
  },
  {
    name: 'Aventura & Diversão',
    desc: 'Trekking, rafting e adrenalina pura.',
    logoKey: 'aventura',
  },
  {
    name: 'Serra & Vinho Experiências',
    desc: 'Enoturismo e charme nas montanhas de SP.',
    logoKey: 'wine',
  },
  {
    name: 'Trilhas & Mochilão Brasil',
    desc: 'Viagens econômicas e campings para jovens.',
    logoKey: 'macela',
  },
  {
    name: 'Fé & Cultura Viagens',
    desc: 'Turismo religioso e histórico com guias especializados.',
    logoKey: 'aparecida',
  },
];
...
export const MOCK_TRIPS: Trip[] = [
  // --- Cataratas do Iguaçu (ag_1) ---
  {
    ...
    description:
      "Explore as Cataratas do Iguaçu, um dos mais espetaculares conjuntos de quedas d'água do planeta. Este pacote inclui passeios pelos lados brasileiro e argentino, além de uma visita ao Parque das Aves.",
    ...
    itinerary: [
      {
        ...
        description: 'Transfer do aeroporto para o hotel e dia livre.',
      },
      {
        day: 2,
        title: 'Lado Brasileiro das Cataratas',
        description: 'Visita ao Parque Nacional do Iguaçu com vista panorâmica das quedas.',
      },
    ],
    boardingPoints: [
    ...
    included: [
      ...
      'Ingresso para o lado brasileiro das Cataratas',
      'Guia local',
    ],
  ...
  // --- Rio de Janeiro (ag_2) ---
  {
    ...
    description:
      'Viva a energia contagiante do Rio. Visite o Cristo Redentor, o Pão de Açúcar, as praias de Copacabana e Ipanema e sinta o ritmo da cidade em um passeio pela Lapa.',
  ...
  // --- Amazônia (ag_3) ---
  {
    ...
    description:
      'Uma imersão completa na maior floresta tropical do mundo. Fique em um lodge na selva, faça trilhas, focagem noturna de jacarés e visite uma comunidade ribeirinha.',
    ...
    included: [
      'Hospedagem em lodge na selva',
      'Pensão completa',
      'Todos os passeios descritos',
      'Guia nativo',
    ],
    notIncluded: ['Passagens aéreas até Manaus', 'Bebidas'],
    views: 9800,
    sales: 75,
    boardingPoints: [{ id: 'bp5', time: '08:30', location: 'Porto de Manaus' }],
  },
  // --- Fernando de Noronha (ag_4) ---
  {
    ...
    description:
      'Descubra o santuário ecológico de Fernando de Noronha. Mergulhe em águas cristalinas, caminhe por praias paradisíacas e encante-se com a vida marinha exuberante.',
    ...
    sales: 110,
    featuredInHero: true,
    boardingPoints: [{ id: 'bp6', time: '10:00', location: 'Aeroporto de Noronha' }],
  },
  // --- Chapada Diamantina (ag_7) ---
  {
    ...
    description:
      'Explore o coração da Bahia em um roteiro de trekking e paisagens deslumbrantes. Visite o Morro do Pai Inácio, a Cachoeira da Fumaça e os poços de águas cristalinas.',
    ...
    sales: 95,
    featuredInHero: true,
    boardingPoints: [{ id: 'bp7', time: '13:00', location: 'Rodoviária de Lençóis' }],
  },
  // --- Rota do Vinho SP (ag_8) ---
  {
    ...
    description:
      'Um dia delicioso explorando as vinícolas de São Roque. Deguste vinhos, sucos e produtos artesanais, e desfrute de um almoço típico em um ambiente charmoso.',
  ...
  // --- Trindade (ag_9) ---
  {
    ...
    description:
      'Fuja da rotina em um fim de semana nas praias e cachoeiras de Trindade. Conheça a Praia do Meio, a Praia do Cachadaço e a famosa piscina natural.',
    ...
    included: [
      'Transporte saindo de SP',
      'Hospedagem em camping ou pousada simples',
      'Guia acompanhante',
    ],
...
export const MOCK_REVIEWS: Review[] = [
  {
    ...
    rating: 5,
    comment:
      'Viagem incrível! O guia era muito experiente e as cataratas são de tirar o fôlego. Recomendo!',
